        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{route('register')}}" class="p-5">
                ...
                <div class="form-group">
                    ...
                    old('name')}}" required autocompleate="name" autofocus placeholder="めるぴっと太郎">
                                       @error('name')
                    ...
                    <div class="form-group">
                        ...
                        old('email')}}" required autocompleate="email" placeholder="melpit@example.com">
                                         @error('email')
                                         <span class="inavalid-feedback" role="alert">
                                             <strong>{{ $message}}</strong>
                                      </span>
                    ...
                    <div class="form-group">
                        ...
                        <input id="password" type="password" class="form-control @error('pasword') is-invalid @enderror" name="password"
                         required autocompleate="new-password" placeholder="password">
                                         @error('password')
                                         <span class="inavalid-feedback" role="alert">
                                             <strong>{{ $message}}</strong>
                                      </span>
